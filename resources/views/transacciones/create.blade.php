    ...
    <div class="container mx-auto px-4 py-8 max-w-lg"> {{-- Contenedor principal centrado y con ancho máximo --}}
        ...
        <form action="{{ route('transacciones.store') }}" method="POST"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="descripcion" id="descripcion" value="{{ old('descripcion') }}" required class="shadow appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline
            ...
            <div class="mb-4">
                ...
                <input type="number" name="monto" id="monto" value="{{ old('monto') }}" required step="0.01" {{-- Agregado
                    step para decimales --}} class="shadow appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline
            ...
            <div class="mb-6">
                ...
                <input type="date" name="fecha_transaccion" id="fecha_transaccion"
                    value="{{ old('fecha_transaccion', '2025-06-10') }}" required class="shadow appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline
